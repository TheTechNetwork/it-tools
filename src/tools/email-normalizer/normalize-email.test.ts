// Upstream's test suite, vendored alongside `normalize-email.ts`.
...
describe('normalize-email', () => {
  describe('normalizeEmail', () => {
    describe('check email validity', () => {
      it('an error is thrown if the email is invalid', () => {
        // Just a domain
    ...
    describe('gmail address', () => {
      it('lowercased, dots are removed and plus tags are stripped', () => {
    ...
    describe('googlemail address', () => {
      it('lowercased, dots are removed, plus tags are stripped, and domain is renamed to gmail.com', () => {
    ...
    describe('hotmail address', () => {
      it('lowercased, dots are not removed, but plus tags are stripped', () => {
    ...
    describe('unsupported domains', () => {
      it('lowercased and return unchanged email', () => {
    ...
    describe('complex cases', () => {
      it('handles multiple dots and plus tags', () => {
